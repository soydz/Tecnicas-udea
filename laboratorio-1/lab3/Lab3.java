...
record InformacionPersonal(String nombres, String apellidos, LocalDate fechaNacimiento, String direccion, String municipio, String nivelAcademico, String ocupacion, char genero, double peso, double estatura){}
	...
	public static void main(String[] args) {
		...
		bd[0] = new InformacionPersonal("Juan","Pérez",LocalDate.parse("15/03/1985", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123","Medellin","Licenciatura en Ingeniería","Ingeniero de Software",'M',70,1.75);
		bd[1] = new InformacionPersonal("María","García",LocalDate.parse("28/07/1992", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123","Medellin","Maestría en Psicología","Psicóloga Clínica",'F',58,1.68);
		bd[2] = new InformacionPersonal("Carlos","Pérez Garcia",LocalDate.parse("10/03/2023", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 123","Medellin","","",'M',3,0.80);
		bd[3] = new InformacionPersonal("Ana","Martínez",LocalDate.parse("05/09/2009", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle 14","Villa","Bachiller","Estudiante",'F',55,1.60);
		bd[4] = new InformacionPersonal("Luisa","Hernández",LocalDate.parse("20/06/1989", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Carrera 789","Envigado","Doctorado en Economía","Profesora Universitaria",'F',63,1.70);
		bd[5] = new InformacionPersonal("Javier","López",LocalDate.parse("12/04/1975", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Calle San Juan","Medellin","Licenciatura en Arquitectura","Arquitecto Independiente",'M',75,1.82);
		bd[6] = new InformacionPersonal("Laura","Ramírez",LocalDate.parse("18/04/1998", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Avenida 6","Ciudad Metropolitana","Bachiller","Estudiante",'F',52,1.65);
		bd[7] = new InformacionPersonal("Martín","Torres",LocalDate.parse("30/02/1998", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Avenida 6","Aldea","Bachiller","Estudiante",'M',68,1.78);
		bd[8] = new InformacionPersonal("Sofia","Vargas",LocalDate.parse("22/07/1995", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Avenida 6","Rionegro","Bachiller","Estudiante",'F',60,1.63);
		bd[9] = new InformacionPersonal("Daniel","Sánchez",LocalDate.parse("08/12/1999", DateTimeFormatter.ofPattern("dd/MM/uuuu")),"Avenida 6","Rionegro","Bachiller","Estudiante",'M',72,1.79);
		...
		double mediaPesos = 0;
		double personasPesos = bd.length;
		...
		double masBajo = bd[0].estatura;
		double masAlto = bd[0].estatura;
		for(InformacionPersonal i:bd){
		...
		System.out.println("De " + bd.length + " personas, " + numMasculino + " son hombres y " + numFemenina + " mujeres");
		System.out.println("/**************************************/");
...
//5. Edades:
		...
		long menorEdad = ChronoUnit.DAYS.between(LocalDate.now(), bd[0].fechaNacimiento);
